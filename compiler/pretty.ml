...
let format_decl (fmt : Format.formatter) (print_a : 'a -> string) (d : 'a decl) : unit =
  ...
  | DFun (name, args, body, allow_shadow, a) ->
      ...
      print_comma_sep fmt;
      pp_print_string fmt "Shadow: ";
      pp_print_bool fmt allow_shadow;
      print_comma_sep fmt;
